...
def get_img_folder_of_typora(md_path):
    return md_path.replace(".md", ".assets")

def get_img_folder_of_images(md_path):
    return os.path.join(md_path, "../images")

def run_conversion(abs_md_path: str, replace: bool):
    ...
    abs_img_dir_path = get_img_folder_of_images(md_path=abs_md_path)
